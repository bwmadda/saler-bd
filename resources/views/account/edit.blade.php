								...
								<h3 class="no-padding text-center-480 useradmin">
									<a href="">
									    @if(!empty($user->filename))
									        <img class="userImg" src="/uploads/user/{{ $user->filename }}" alt="user">&nbsp;
									    @else
                                            @if (!empty($gravatar))
							...
							<div class="panel panel-default">
								...
								<div class="panel-collapse collapse {{ (old('panel')=='' or old('panel')=='userPanel') ? 'in' : '' }}" id="userPanel">
									<div class="panel-body">
										<form name="details" enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ url()->current() }}">
											{!! csrf_field() !!}
                                            ...
                                            */
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="input-group">
														<input type="file" name="filename" id="filename" title="Browse file"/>
													</div>
												</div>
											</div>
