	...
	if (isDemoDomain()) {
		if (auth()->check()) {
			if (isFromAdminPanel()) {
				...
				if (
					!str_contains(\Illuminate\Support\Facades\Route::currentRouteAction(), 'Post\CreateController') &&
					!str_contains(\Illuminate\Support\Facades\Route::currentRouteAction(), 'Post\EditController') &&
					!str_contains(\Illuminate\Support\Facades\Route::currentRouteAction(), 'Post\PhotoController') &&
					!str_contains(\Illuminate\Support\Facades\Route::currentRouteAction(), 'Post\PackageController') &&
					!str_contains(\Illuminate\Support\Facades\Route::currentRouteAction(), 'Post\DetailsController') &&
					!str_contains(\Illuminate\Support\Facades\Route::currentRouteAction(), 'Post\ReportController') &&
					!str_contains(\Illuminate\Support\Facades\Route::currentRouteAction(), 'Ajax\PostController') &&
					!str_contains(\Illuminate\Support\Facades\Route::currentRouteAction(), 'Account\ConversationsController')
				) {
					return true;
				}
			}
