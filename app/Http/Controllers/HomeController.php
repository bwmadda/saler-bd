...
class HomeController extends FrontController
{
	...
	public function index()
	{
        ...
        //$data['cats'] = Category::trans()->where('parent_id', 0)->orderBy('lft')->get();
        $data['cats'] = Category::trans()->where('parent_id', 0)
            ->with([
        ...
        //echo "<pre>";
        //print_r($data['cats']);
        //print_r($data['catWithSbu']); die;
        $data['categoryPost'] = $this->getPosts(1000);
